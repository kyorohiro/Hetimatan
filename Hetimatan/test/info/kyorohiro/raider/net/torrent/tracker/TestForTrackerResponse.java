...
import info.kyorohiro.raider.net.torrent.tracker.db.TrackerData;
...
import info.kyorohiro.raider.util.bencode.BenDiction;
...
//			data.removePeerInfo(info002);
	...
	public TrackerPeerInfo createPeerInfo(byte[] targetFileContent) throws IOException {
		...
		HttpRequestURI uri = HttpRequestURI.newInstance("dummy", "/adsdannounce", "dummy")
